...
namespace WebPage.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var customer = await _context.TestCustomer1
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var customer = await _context.TestCustomer1.FindAsync(id);
            if (customer == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (customer != null)
            {
                _context.TestCustomer1.Remove(customer);
            }
        ...
        {
            return _context.TestCustomer1.Any(e => e.Id == id);
        }
    }
}
